...
>[!TIP]
> Vous trouverez [ici](/intune-classic/get-started/what-to-know-before-you-start-microsoft-intune) plus d’informations sur la configuration Intune autonome requise.
...
-   En savoir plus sur [comment ajouter des utilisateurs/groupes dans Intune](/intune-classic/get-started/start-with-a-paid-subscription-to-microsoft-intune-step-3).
...
-   En savoir plus sur [comment attribuer des licences Intune](/intune-classic/get-started/start-with-a-paid-subscription-to-microsoft-intune-step-4).
...
-   Découvrez comment [la configuration de la gestion des appareils iOS et Mac fonctionne.]/intune-classic/deploy-use/set-up-ios-and-mac-management-with-microsoft-intune)
