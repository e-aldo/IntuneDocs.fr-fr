...
3. Dans le panneau **De base**, pour la plupart des questions de support technique Intune, choisissez ce qui suit :
...
4. Dans le panneau **Problème**, pour vous assurer que votre demande est traitée par l’expert technique le plus à même de résoudre votre problème, sélectionnez les options suivantes :
 ...
 Pour nous aider à identifier et résoudre votre problème, entrez les informations suivantes :
    -   **Détails**
    - **Date**
    - **Heure**
...
- [Contacter le support par téléphone pour Microsoft Intune](contact-assisted-phone-support-for-microsoft-intune.md)
- [Centre de gestion des licences en volume](http://go.microsoft.com/fwlink/p/?LinkID=282016)
- [Support relatif à la gestion de la facturation et des abonnements](https://support.office.com/article/Contact-Office-365-for-business-support-Admin-Help-32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b?ui=en-US&rs=en-US&ad=US)
