...
Vous pouvez trouver une liste des appareils Samsung KNOX pris en charge, ainsi que la liste des [appareils pris en charge par Intune](/intune/supported-devices-browsers.md#intune-supported-devices).
