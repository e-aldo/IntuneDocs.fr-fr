...
Windows en tant que service permet de mettre à jour des appareils Windows 10. Avec Windows 10, les nouvelles mises à jour de fonctionnalités et qualité incluent le contenu de toutes les mises à jour précédentes. Cela signifie que tant que vous avez installé la dernière mise à jour, vous savez que vos appareils Windows 10 sont entièrement à jour. À la différence des versions précédentes de Windows, vous devez maintenant installer la mise à jour complète au lieu d’une partie seulement.
...
- **Paramètres des reports** : configurez les paramètres de report des mises à jour pour différer l’installation des mises à jour pour des groupes d’appareils. Utilisez ces paramètres pour procéder au déploiement des mises à jour par étapes, ce qui vous permet d’examiner la progression tout au long du processus.
...
1. Pour affecter l’anneau, dans la liste des anneaux de mise à jour, sélectionnez un anneau, puis sous l’onglet du *nom de l’anneau*, choisissez **Affectations**.
...
Vous pouvez surveiller les déploiements de mises à jour Windows 10 à l’aide d’une solution gratuite d’Operations Management Suite (OMS) appelée Update Compliance. Pour plus d’informations, consultez [Analyse des mises à jour Windows avec la conformité de la mise à jour](https://technet.microsoft.com/itpro/windows/manage/update-compliance-monitor). Lorsque vous utilisez cette solution, vous pouvez déployer un ID commercial dans un des appareils Windows 10 gérés par Intune pour lequel vous souhaitez générer des rapports sur la conformité des mises à jour.
...
## <a name="how-to-pause-updates"></a>Comment suspendre des mises à jour
