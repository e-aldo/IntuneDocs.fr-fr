...
| **Exiger une version minimale du système d’exploitation Android** | Choisissez **Oui** pour exiger une version minimale du système d’exploitation Android pour utiliser cette application. L’accès de l’utilisateur est bloqué si la version d’Android sur l’appareil ne répond pas à la condition. <br><br> | Non |
| **Exiger une version minimale du système d’exploitation Android (avertissement uniquement)** | Choisissez **Oui** pour recommander une version minimale du système d’exploitation Android pour utiliser cette application. Une notification s’affiche à l’intention de l’utilisateur si la version d’Android sur l’appareil ne répond pas à la condition. Cette notification peut être ignorée. <br><br> | Non |
