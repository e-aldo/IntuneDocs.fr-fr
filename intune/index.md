...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            ...
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Articles présentés</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Articles les plus lus</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Articles recommandés</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Nouveaux articles</h3>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune dans le portail Azure</h3>
                                            <p>Microsoft Intune est disponible dans le portail Azure. Découvrez-en davantage sur la gestion des appareils et des applications dans le nouveau portail. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Prise en main de Microsoft Intune</h3>
                                            <p>Découvrir les bases : Créer un groupe et un utilisateur. Inscrire des appareils. Affecter des stratégies et des applications.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Plus de 150 licences ? Tirez profit de vos avantages FastTrack</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Où se trouve ma fonctionnalité Intune dans Azure ?</h3>
                                            <p>Si vous connaissez Intune dans la console classique, cet article va vous aider à trouver votre fonctionnalité dans Intune sur Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/what-is-intune">toute la documentation d’Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Découvrez comment Intune fournit des fonctionnalités de gestion d’appareils, d’applications et de données pour des appareils mobiles et des PC Windows.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/what-is-intune">toute la documentation d’introduction</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Planifier un déploiement</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Appareils et navigateurs pris en charge</h3>
                                            <p>Plus d’informations sur les appareils et les navigateurs pris en charge par le service.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Guide de planification, de conception et d’implémentation du déploiement</h3>
                                            <p>Développer un plan de déploiement, créer une conception, intégrer Intune et effectuer un déploiement de production.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Guide de migration</h3>
                                            <p>Obtenez tous les détails sur la migration à partir d’un fournisseur tiers de gestion des appareils mobiles vers Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune-classic/plan-design/introduction">toute la documentation de planification du déploiement</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Guide pratique</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Créer une stratégie d’accès conditionnel</h3>
                                            <p>Configurez l’accès conditionnel pour Exchange sur site basé sur la compatibilité des appareils.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Configurer l’autorité MDM</h3>
                                            <p>Découvrez les options disponibles lors de la configuration de l’autorité de gestion des appareils mobiles.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Configurer les profils d’appareils</h3>
                                            <p>Découvrez comment créer des profils de configuration d’appareils dans Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Configurer des restrictions sur les appareils</h3>
                                            <p>Découvrez comment configurer les paramètres de restriction de l’appareil dans Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Gérer des applications</h3>
                                            <p>Découvrez comment ajouter, attribuer et surveiller des applications.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Créer et affecter des stratégies de protection des applications</h3>
                                            <p>Découvrez comment créer et affecter des stratégies de protection des applications.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/device-enrollment">toute la documentation de guide pratique</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">Surveiller et dépanner</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Obtenir un support technique pour Intune</h3>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>En savoir plus sur les problèmes connus dans Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Résoudre les problèmes de déploiement d’applications</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Résoudre les problèmes d’inscription des appareils</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Résoudre les problèmes de profils d’appareils</h3>
                                            <p>Résolvez les problèmes rencontrés lors de la création de profils pour les appareils.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Résoudre les problèmes de profil de messagerie</h3>
                                            <p>Résolvez les problèmes rencontrés lors de la création de profils de messagerie.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">toute la documentation de dépannage</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
        ...
        <li>
            <a href="#sdkstools">Kits SDK/Outils</a>
            <ul id="sdkstools">
                <li>
                    <a href="#sdkstools-all">Tous</a>
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Préparer des applications métier pour la gestion des appareils mobiles</h3>
                                            <p>Configurez vos applications pour utiliser des stratégies de gestion des applications mobiles (GAM) à l’aide de l’outil de création de package de restrictions d’application Intune ou du SDK d’application Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vous recherchez toute la documentation ? Consultez <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">toute la documentation d’Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Envoyer des commentaires sur Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Suivez Microsoft Intune sur Twitter</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Questions et réponses sur le forum</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Lire le blog Enterprise Mobility + Security</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Envoyer des commentaires sur le service Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Envoyer des commentaires sur la documentation Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
