...
Les utilisateurs des applications et des appareils de votre entreprise (le personnel de votre entreprise) peuvent avoir plusieurs exigences d’applications. Avant d’ajouter des applications à Intune et de les rendre disponibles pour votre personnel, vous devez évaluer et comprendre quelques principes de base sur les applications. Vous devez comprendre les différents types d’applications disponibles pour Intune. Vous devez évaluer les exigences d’applications, telles que les plateformes nécessaires et les fonctionnalités requises pour votre personnel. En outre, vous devez déterminer si vous utilisez Intune pour gérer les appareils (y compris les applications) ou pour gérer des applications sans gérer des appareils. Vous devez déterminer qui parmi votre personnel aura besoin de différentes applications et de différentes fonctionnalités. Les informations fournies dans cet article vous aideront pour la prise en main.

## <a name="app-types-in-microsoft-intune"></a>Types d’applications dans Microsoft Intune

Intune prend en charge un large éventail de types d’application différents. Les options disponibles diffèrent pour chaque type d’application. Intune vous permet d’ajouter et d’affecter les types d’application suivants :

| **Types d’application**                                     | **Installation**                                                                  | **Mises à jour**                       |
|------------------------------------------ |----------------------------------------------------------------------------   |---------------------------    |
...
Le tableau suivant répertorie les types d’application spécifiques et la façon dont vous pouvez les ajouter à partir du panneau **Ajouter application** dans Microsoft Intune :

| **Type spécifique d’application**                         | **Type général**             | **Procédures spécifiques à l’application**                                                                                                                                                 |
|---------------------------------------------|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Applications du magasin Android                        | Application Store                  | Sélectionnez **Android** comme le **type d’application** et entrez l’URL du magasin Google Play pour l’application.                                                                                       |
| Applications du magasin iOS                            | Application Store                  | Sélectionnez **iOS** comme le **type d’application**, recherchez l’application et sélectionnez l’application dans Intune.                                                                                     |
| Applications du magasin Windows Phone 8.1              | Application Store                  | Sélectionnez **Windows Phone 8.1** comme le **type d’application** et entrez l’URL du magasin Microsoft de l’application.                                                                               |
| Applications Microsoft Store                      | Application Store                  | Sélectionnez **Windows** comme le **type d’application** et entrez l’URL du magasin Microsoft de l’application.                                                                                         |
| Applications Android for Work                     | Application Store                  | Recherchez et approuvez l’application Android for Work à partir du magasin Google Play for Work.                                                                                        |
| Applications Office 365 pour Windows 10            | Application Store (Office 365)     | Sélectionnez **Windows 10** sous la **Suite Office 365** comme le **type d’application**, puis sélectionnez l’application Office 365 que vous souhaitez installer.                                                |
| Applications Office 365 pour macOS                 | Application Store (Office 365)     | Sélectionnez **macOS** sous la **Suite Office 365** comme le **type d’application**, puis sélectionnez la suite d’applications Office 365.                                                                     |
| Applications métier Android       | Application métier | Sélectionnez l’application **métier** comme le **type d’application**, sélectionnez le **fichier Package d’application**, puis entrez un fichier d’installation Android avec l’extension **.apk**.                    |
| Applications métier iOS           | Application métier | Sélectionnez l’application **métier** comme le **type d’application**, sélectionnez le **fichier Package d’application**, puis entrez un fichier d’installation iOS avec l’extension **.ipa**.                        |
| Applications métier Windows Phone | Application métier | Sélectionnez l’application **métier** comme le **type d’application**, sélectionnez le **fichier Package d’application**, puis entrez un fichier d’installation iOS avec l’extension **.xap**.                        |
| Applications métier Windows       | Application métier | Sélectionnez l’application métier comme le type d’application, sélectionnez le fichier Package d’application et entrez un fichier d’installation iOS avec l’extension **.msi**, **.appx** ou **.appxbundle**. |
| Application iOS intégrée                          | Application intégrée               | Sélectionnez **Application intégrée** comme le **type d’application**, puis sélectionnez l’application intégrée dans la liste des applications fournies.                                                                  |
| Application Android intégrée                      | Application intégrée               | Sélectionnez **Application intégrée** comme le **type d’application**, puis sélectionnez l’application intégrée dans la liste des applications fournies.                                                                  |
| Applications Web                                  | Application Web                    | Sélectionnez **lien Web** comme le **type d’application** et entrez une URL valide pointant vers l’application Web.                                                                                        |

   
Vous pouvez ajouter une application dans Microsoft Intune en sélectionnant **Applications mobiles** > **Applications** > **Ajouter**. Le panneau **Ajouter application** s’affiche et vous permet de sélectionner le **Type d’application**. 
...
- **Applications du magasin** : une application Store est une application qui a été chargée sur le magasin Microsoft, iOS ou Android. Le fournisseur de l’application de Store gère et fournit les mises à jour sur l’application. Vous sélectionnez l’application à partir de la liste de stores et vous l’ajoutez à l’aide d’Intune comme application disponible pour vos utilisateurs.
...
Les applications gérées par Intune peuvent également activer la protection des applications sans inscription obligatoire, ce qui vous donne la possibilité d’appliquer des stratégies de protection contre la perte de données sans gérer l’appareil de l’utilisateur. De plus, vous pouvez incorporer la gestion des applications mobiles à vos applications mobiles et métier à l’aide du Kit de développement logiciel (SDK) des applications Intune et de l’outil d’habillage des applications. Pour plus d’informations sur ces outils, consultez [Vue d’ensemble du Kit de développement logiciel (SDK) des applications Intune](app-sdk.md).

### <a name="understanding-licensed-apps"></a>Présentation des applications sous licence
En plus des applications Web, des applications Store et des applications métier, vous devez également avoir connaissance de la destination des applications du programme d’achat en volume et des applications sous licence, notamment :     
