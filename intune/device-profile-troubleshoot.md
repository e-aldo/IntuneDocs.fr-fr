...
Si l’appareil vient d’être inscrit, l’enregistrement est plus fréquent :
...
Pour les appareils sans affinité utilisateur, la fréquence de synchronisation immédiatement après l’inscription peut varier entre quelques heures et un jour ou plus. Intune envoie des demandes à des intervalles différents pour qu’un appareil s’enregistre auprès du service. Toutefois, il revient à l’appareil de le faire réellement. Après l’inscription initiale, selon le type d’inscription de l’appareil et les stratégies et les profils affectés à un appareil, il est impossible de prédire le temps nécessaire à un appareil pour effectuer cet enregistrement. Toutefois, une fois que l’appareil est inscrit et que toutes les stratégies initiales ont été appliquées, l’appareil doit rechercher de nouvelles stratégies environ toutes les six heures.
...
Au bas du menu de navigation de gauche figure le lien **Réinitialiser les stratégies de sécurité**. Choisissez-le, puis choisissez le bouton **Réinitialiser les stratégies**.
