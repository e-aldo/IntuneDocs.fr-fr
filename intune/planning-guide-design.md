...
Reportez-vous à la [Section 3 : déterminer les exigences du scénario d’utilisation](planning-guide-requirements.md) pour plus d'informations sur les scénarios d'utilisation d'entreprise et BYOD.
