...
C’est parce que les licences utilisateur iOS VPP peuvent autoriser l’inscription de milliers d’appareils à l’aide du même compte d’utilisateur. Les licences utilisateur iOS VPP permettent à un utilisateur final d’installer une application sur 5 à 10 appareils.
Cela signifie que pour les premier appareils DEM inscrits, l’application VPP est installée à l’aide de la licence utilisateur et que les autres appareils n’obtiennent pas l’application.
...
2.  Dans le panneau de liste d’applications, choisissez l’application que vous souhaitez attribuer, puis choisissez « **...** » > **Attribuer des groupes**.
