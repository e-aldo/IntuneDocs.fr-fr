...
description: Découvrez comment utiliser Apple Configurator pour inscrire des appareils iOS appartenant à l’entreprise avec l’Assistant Configuration (nouvelle interface utilisateur).
keywords: ''
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
>Si votre page **Inscription des appareils** ressemble à l’image ci-dessous, c’est le signe que votre compte n’est pas encore passé à la nouvelle interface utilisateur. Accédez à [cette page d’aide](apple-configurator-enroll-ios.md).
>
