...
description: "Découvrez comment utiliser Apple Configurator pour inscrire des appareils iOS détenus par l’entreprise avec l’Assistant Configuration (nouvelle interface utilisateur)."
keywords: 
author: ErikjeMS
ms.author: erikje
manager: dougeby
