...
description: "Découvrez comment configurer l’inscription au programme Apple School Manager pour les appareils iOS détenus par l’entreprise avec Intune (nouvelle interface utilisateur)."
keywords: 
author: ErikjeMS
ms.author: erikje
manager: dougeby
