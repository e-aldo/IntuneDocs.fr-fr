...
ms.locfileid: "39039435"
---
# <a name="troubleshoot-device-enrollment-in-intune"></a>Résoudre les problèmes d’inscription d’appareils dans Intune

Cet article fournit des suggestions pour résoudre les problèmes liés à l’inscription d’appareils. Si ces informations ne vous permettent pas de remédier à votre problème, consultez [Comment obtenir un support technique pour Microsoft Intune](get-support.md) pour accéder à d’autres types d’assistance.
...
Vérifiez si le nombre d’appareils affectés à l’utilisateur est supérieur au nombre maximal. Pour cela, effectuez les étapes suivantes :
