---
title: Guide pratique pour désactiver la collecte de données Microsoft pour les appareils macOS | Microsoft Docs
description: ''
keywords: ''
author: lenewsad
ms.author: lanewsad
...
Si vous souhaitez désactiver la collecte des données d’utilisation sur votre appareil macOS, ouvrez l’application Portail d’entreprise, puis sélectionnez le menu **Portail d’entreprise**. Ouvrez **Préférences** et, sous **Envoyer des données d’utilisation à Microsoft**, décochez la case **Autoriser Microsoft à collecter des informations**.
