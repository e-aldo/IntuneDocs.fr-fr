---
title: "Résolution des menaces détectées par Skycure sur iOS | Microsoft Docs"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
![Message de non-conformité issu de Lookout for Work](./media/ios-skycure-noncompliant-in-ssp.png)
...
Si vous avez installé une application qu’il considère comme une menace, le logiciel Skycure vous en informe et ce, dans l’application.

Dans ce cas, appuyez sur le nom de l’application qui apparaît en haut de l’écran et suivez les instructions pour supprimer la menace.
