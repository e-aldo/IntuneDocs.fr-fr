...
## [Planification du déploiement, conception et implémentation](plan-design/introduction.md)
...
## [Migrer](plan-design/intune-mdm-migration-guide.md)
### [Phase 1 : Préparer Intune pour la Gestion des appareils mobiles](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [Configuration de base](plan-design/migration-phase1-basic-setup.md)
#### [Configurer les stratégies de gestion des appareils mobiles et des applications](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [Configurer les stratégies de protection des applications](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [Facteurs de migration spécifiques à prendre en compte](plan-design/migration-phase1-special-migration-considerations.md)
### [Phase 2 : Campagne de migration](plan-design/migration-phase2-migration-campaign.md)
#### [Plan de communication](plan-design/migration-phase2-communication-plan.md)
#### [Adoption de lecteur](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [Cycle de migration classique](plan-design/migration-phase2-typical-migration-cycle.md)

# [Nouveautés](whats-new/whats-new-in-microsoft-intune.md)
## [Nouveautés de l’interface utilisateur des applications](whats-new/whats-new-in-intune-app-ui.md)
...
### [Chargement indépendant d'applications Windows](deploy-use/sideload-apps-for-windows.md)
...
### [Expérience utilisateur final pour Android avec les applications prenant en charge MAM](deploy-use/user-experience-for-mam-enabled-android-apps-with-microsoft-intune.md)
### [Expérience utilisateur final pour iOS avec les applications prenant en charge MAM](deploy-use/user-experience-for-mam-enabled-ios-apps-with-microsoft-intune.md)
