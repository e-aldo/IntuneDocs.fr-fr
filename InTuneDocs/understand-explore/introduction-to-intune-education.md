---
title: "Qu’est-ce qu’Intune pour l’Éducation ? | Microsoft Docs"
...
Intune pour l’Éducation peut être utilisé seul ou avec l’[intégralité de l’expérience de gestion des appareils disponible dans Intune](/understand-explore/introduction-to-microsoft-intune). Il peut également être utilisé en association avec les autres outils disponibles dans [Microsoft Éducation](https://microsoft.com/education), ce qui facilite votre utilisation d’Intune pour l’Éducation avec d’autres outils de formation utiles de Microsoft.
...
* En savoir plus sur la façon la plus rapide de [commencer à utiliser Intune pour l’Éducation](https://docs.microsoft.com/intune-education/what-is-express-configuration).
