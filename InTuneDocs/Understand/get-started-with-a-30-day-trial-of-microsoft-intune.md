...
# <a name="intune-evaluation-guide"></a>Guide d'évaluation de Microsoft Intune
...
## <a name="steps-to-complete-a-30day-evaluation-of-intune"></a>Étapes de l’exécution d’une version d’évaluation de 30 jours d’Intune
