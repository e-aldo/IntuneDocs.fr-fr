...
-   En savoir plus sur la façon de [configurer le fournisseur MAM avec Intune](https://docs.microsoft.com/intune/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10).
