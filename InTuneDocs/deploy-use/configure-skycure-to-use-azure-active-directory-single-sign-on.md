...
[Télécharger la stratégie de configuration d’application iOS Skycure](https://docs.microsoft.com/intune/deploy-use/download-skycure-ios-app-configuration-policy)
