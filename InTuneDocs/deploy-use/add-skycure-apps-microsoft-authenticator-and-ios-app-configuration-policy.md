...
-   Vérifiez que vous êtes familiarisé avec ce processus :
    ...
    -   [Ajout d’une application dans Intune](https://docs.microsoft.com/intune/deploy-use/add-apps).
...
[Déployer des applications Skycure, l’application Microsoft Authenticator et une stratégie de configuration d’application iOS](https://docs.microsoft.com/intune/deploy-use/deploy-skycure-apps-microsoft-authenticator-app-and-ios-app-configuration-policy)
