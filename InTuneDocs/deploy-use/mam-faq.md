...
**Comment Intune réinitialise-t-il des données à distance ?** Intune peut réinitialiser des données d’application de deux manières différentes : réinitialisation complète et réinitialisation sélective. Pour plus d'informations sur la réinitialisation sélective, consultez [Protégez vos données avec la réinitialisation complète ou sélective à l’aide de Microsoft Intune](use-remote-wipe-to-help-protect-data-using-microsoft-intune.md).
  ...
  2. **Qu’est-ce-que la réinitialisation sélective ?** Consultez la rubrique [Protégez vos données avec la réinitialisation complète ou sélective à l’aide de Microsoft Intune](use-remote-wipe-to-help-protect-data-using-microsoft-intune.md#selective-wipe) pour en savoir plus sur la réinitialisation sélective.

  3. **Quelle est la vitesse de la réinitialisation sélective ?** Si l’utilisateur utilise l’application lorsque la réinitialisation sélective est lancée, le Kit de développement logiciel (SDK) d’application Intune contrôle toutes les 30 minutes la présence d’une requête de réinitialisation sélective du service de GAM Intune. Il vérifie également la présence d’une réinitialisation sélective lorsque l’utilisateur lance l’application pour la première fois et se connecte avec son compte professionnel ou scolaire.
