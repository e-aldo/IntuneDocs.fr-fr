...
Pour préparer votre abonnement au service Lookout de protection des appareils contre les menaces, le support technique de Lookout ((enterprisesupport@lookout.com)) a besoin des informations suivantes sur votre abonnement Azure Active Directory (Azure AD). Votre locataire Lookout Mobility Endpoint Security sera associé à votre abonnement Azure AD pour intégrer Lookout à Intune. 
...
![capture d’écran de la page Azure AD montrant le nom du locataire](../media/mtp/aad_tenant_name.png) Quand vous choisissez le nom de votre abonnement, l’URL résultante inclut l’ID de l’abonnement.  Si vous ne trouvez pas votre ID d’abonnement, consultez cet [article du support technique Microsoft](https://support.office.com/en-us/article/Find-your-Office-365-tenant-ID-6891b561-a52d-4ade-9f39-b492285e2c9b?ui=en-US&rs=en-US&ad=US) qui fournit des conseils à cette fin.   
