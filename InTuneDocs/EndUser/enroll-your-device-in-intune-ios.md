...
10.  Quand l’écran change et indique que l’installation du profil est terminée, cliquez sur **Terminé**.

    ![ios-enroll-tap-done](./media/ios-enroll-6-done.png) 

    Un message « Inscription de l’appareil » s’affiche à l’écran.

11.  Quand un message vous invite à ouvrir la page dans le Portail d’entreprise, cliquez sur **Ouvrir**.
