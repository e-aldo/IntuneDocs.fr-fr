...
description: "Apprenez à utiliser Microsoft Intune (FIXME)"
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Utiliser Intune dans Microsoft Graph</a></h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">Plus de 150 licences ? Tirer profit de vos avantages FastTrack</a></h3>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/understand-explore/introduction-to-microsoft-intune">toute la documentation d’Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/understand-explore/introduction-to-microsoft-intune">toute la documentation d’introduction</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Déterminer les objectifs et les défis</h3>
                                            <p>Évaluez les objectifs et les défis à gérer lors du déploiement.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Identifier des scénarios d’utilisation</h3>
                                            <p>Passez en revue quelques exemples d’utilisation lorsque vous avez identifié vos scénarios de déploiement. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Développer un plan de déploiement</h3>
                                            <p>Déterminez les groupes de l’organisation qui sont ciblés par votre déploiement Intune et le calendrier de déploiement pour chaque groupe.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/plan-design/introduction">toute la documentation de planification du déploiement</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">toute la documentation Guide pratique</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>En savoir plus sur les problèmes connus dans la version préliminaire d’Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consultez <a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">toute la documentation de dépannage</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vous recherchez toute la documentation ? Consultez <a href="/intune/understand-explore/introduction-to-microsoft-intune">toute la documentation d’Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
