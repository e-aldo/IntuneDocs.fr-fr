...
## Personnaliser les groupes de votre organisation
...
Pour simplifier la gestion des stratégies, nous vous recommandons de nommer chaque stratégie d’après la fonction, la plateforme et l’étendue auxquels elle s’applique. Utilisez une norme de nommage qui suit la structure de groupe que vous avez créée quand vous avez préparé l’application de vos stratégies.
