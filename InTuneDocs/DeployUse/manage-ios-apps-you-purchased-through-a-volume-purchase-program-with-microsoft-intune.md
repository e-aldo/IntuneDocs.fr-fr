...
* Une fois que vous associez un compte Apple VPP à Intune, vous ne pouvez plus en associer un autre. C’est la raison pour laquelle il est très important que plusieurs personnes disposent des informations du compte que vous utilisez.
...
> [!TIP]
> Vous devez choisir l’action de déploiement **Requis**. Les installations disponibles ne sont pas prises en charge.
