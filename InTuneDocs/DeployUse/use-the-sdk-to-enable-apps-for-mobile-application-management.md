...
Pour une vue d’ensemble du Kit de développement logiciel (SDK), consultez la page [Vue d’ensemble](https://msdn.microsoft.com/en-us/library/mt627767.aspx). Pour utiliser le Kit de développement logiciel (SDK) d’application Intune, consultez [Prise en main du Kit de développement logiciel (SDK) de l’application Microsoft Intune](https://msdn.microsoft.com/library/mt627766.aspx).
