...
> [!TIP]
> Quand une stratégie contenant des paramètres est déployée sur un appareil Android, l’utilisateur est invité à effectuer une action pour se conformer à la stratégie. Les nouveaux paramètres de stratégie prennent effet uniquement quand l’utilisateur a effectué cette action ou que l’appareil a été redémarré.
