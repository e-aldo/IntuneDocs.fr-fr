...
Pour appliquer des restrictions à une application, celle-ci doit intégrer le Kit de développement logiciel (SDK) d’application Microsoft. Il existe deux méthodes pour obtenir ce type d'application :
...
-   **Pour créer une application encapsulée** : utilisez les informations fournies dans les rubriques [Préparer des applications iOS pour la gestion des applications mobiles avec l’outil de création de package de restrictions d’application Microsoft Intune](prepare-ios-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md) et [Préparer des applications Android pour la gestion des applications mobiles avec l’outil de création de package de restrictions d’application Microsoft Intune](prepare-android-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md) pour créer une application encapsulée.

    L'outil crée une application traitée que vous utilisez quand vous publiez l'application dans votre espace de stockage cloud.
...
2.  Effectuez l'une des étapes suivantes :
    ...
    -   Cliquez sur **Tous les utilisateurs**, puis double-cliquez sur l’utilisateur dont vous souhaitez examiner les appareils. Dans la page **Propriétés de l’utilisateur**, cliquez sur **Appareils**, puis double-cliquez sur l’appareil à examiner.

    -   Cliquez sur **Tous les appareils** &gt; **Tous les appareils mobiles**. Dans la page **Propriétés du groupe d’appareils**, cliquez sur **Appareils**, puis double-cliquez sur l’appareil à examiner.

3.  Dans la page **Propriétés de l'appareil mobile** , cliquez sur **Stratégie** pour afficher la liste des stratégies de gestion des applications mobiles qui ont été déployées sur l'appareil.
