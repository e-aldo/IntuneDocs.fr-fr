...
## Septembre 2016
### Nouvelles fonctionnalités, annonces et informations
...
* Utilisez **Obtenir de l’aide** pour signaler un problème à votre service informatique au sujet du portail d’entreprise. Ce service crée un e-mail en utilisant votre client de messagerie et y joint les journaux du portail d’entreprise. **Obtenir de l’aide** remplace la fonctionnalité **Envoyer les données** dans la page **paramètres**.
...
__Applications masquées et affichées pour iOS 9.3__ Pour les appareils supervisés exécutant iOS 9.3 ou une version ultérieure, vous pouvez utiliser la liste des applications affichées et masquées dans la stratégie de configuration générale d’iOS pour :
...
__Prise en charge d’iOS 10__ Intune prendra entièrement en charge iOS 10. D’autres informations seront fournies au moment du lancement de la version publique d’iOS 10.
...
### Mises à jour du Portail d’entreprise Intune
