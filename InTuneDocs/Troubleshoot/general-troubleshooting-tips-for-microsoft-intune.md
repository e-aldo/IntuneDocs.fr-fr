...
> [!NOTE]
> Pour créer une demande de support technique ou examiner une demande existante, cliquez [ici](https://portal.office.com/admin/default.aspx) pour visiter le centre d’administration Office 365. Pour plus d’informations sur les options de support technique, consultez la page [Comment obtenir un support technique pour Microsoft Intune](how-to-get-support-for-microsoft-intune.md).
## Définir le problème
...
-   Vous pouvez ouvrir une demande de support technique. Le Support technique Intune pourra mieux vous aider à résoudre votre problème si vous l’avez clairement défini et que vous avez recueilli les données disponibles.
    ...
    Pour créer une demande de support technique, cliquez [ici](https://portal.office.com/admin/default.aspx) pour accéder au centre d’administration Office 365. Pour plus d’informations sur les options de support technique, consultez la page [Comment obtenir un support technique pour Microsoft Intune](how-to-get-support-for-microsoft-intune.md).
