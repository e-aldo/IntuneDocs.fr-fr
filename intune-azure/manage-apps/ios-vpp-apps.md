...
Lorsque vous déployez une application VPP en tant que Disponible, le contenu et la licence de l’application sont déployés directement à partir de l’App Store.
