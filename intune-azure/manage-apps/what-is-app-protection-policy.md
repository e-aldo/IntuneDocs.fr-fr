---
title: "Que sont les stratégies de protection d’application | Version préliminaire d’Intune Azure | Microsoft Docs"
description: "Version préliminaire d’Intune Azure : utilisez cette rubrique pour apprendre à protéger les données de votre entreprise avec les stratégies de protection d’application Microsoft Intune."
keywords: 
author: NathBarn
ms.author: nathbarn
manager: angrobe
...
Les applications qui prennent en charge plusieurs identités vous permettent d’utiliser des comptes différents (professionnels et personnels) pour accéder aux applications auxquelles des stratégies de protection d’application sont appliquées lorsque les applications sont utilisées dans le contexte de travail.
