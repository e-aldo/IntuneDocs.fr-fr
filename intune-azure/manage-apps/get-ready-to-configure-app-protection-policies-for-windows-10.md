...
[Créer une stratégie de protection d’application WIP](https://docs.microsoft.com/intune-azure/manage-apps/create-windows-information-protection-policy-with-intune)
