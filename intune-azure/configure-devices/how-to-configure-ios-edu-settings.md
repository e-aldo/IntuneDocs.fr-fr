---
title: "Paramètres Intune pour l’application iOS Classroom | Microsoft Docs"
titleSuffix: Intune Azure preview
description: "Préversion Intune Azure : découvrez les paramètres Intune qui vous permettent de contrôler les paramètres pour l’application Classroom sur les appareils iOS."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
Utilisez le profil d’appareil **Éducation** iOS d’Intune et les informations de cette rubrique pour vous aider à configurer l’application Classroom et les appareils sur lesquels vous l’utiliserez.
...
- Vérifiez que vous avez installé l’application [Apple Classroom](https://itunes.apple.com/us/app/classroom/id1085319084?mt=8) sur l’appareil de l’enseignant. Vous pouvez le faire manuellement ou utiliser la [gestion des applications Intune](https://docs.microsoft.com/intune-azure/manage-apps/what-is-app-management).
...
Vous pouvez importer des informations dans SDS en utilisant l’une des méthodes suivantes :
...
- [En savoir plus sur les licences dans Azure Active Directory](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-licensing-whatis-azure-portal)
...
8.    Dans la liste déroulante **Type de profil**, choisissez **Éducation**.
...
Affectez le profil aux appareils des étudiants dans les groupes de salle de classe qui ont été créés quand vous avez synchronisé vos données scolaires avec Azure AD (consultez [Guide pratique pour attribuer des profils d’appareil](/intune-azure/configure-devices/how-to-assign-device-profiles)).
