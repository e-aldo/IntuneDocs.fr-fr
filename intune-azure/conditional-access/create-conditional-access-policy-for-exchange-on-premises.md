...
- Vous devez utiliser le [connecteur Exchange Active Sync sur site](install-intune-on-premises-exchange-connector.md) qui connecte Intune à Exchange sur site.
